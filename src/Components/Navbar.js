...
const Navbar = () =>{
  ...
  <div className="container mx-auto flex justify-between items-center space-x-2"> 
    ...
    <div className="flex items-center space-x-6">
      ...
      <a href="#" className=" text-lg relative hover:text-[#B17457] transition duration-300">Attractions</a>
      <a href="#" className=" text-lg relative hover:text-[#B17457] transition duration-300">Trending</a>
      <div className="relative group mr-6">
    <a href="#" className="text-lg relative hover:text-[#B17457] transition duration-300">Places</a>
