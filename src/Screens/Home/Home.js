...
const HomePage = () => {
  ...
  return (
     <div className="min-h-screen bg-gradient-to-b from-[#FAF7F0] via-[#D8D2C2] to-[#B17457] text-[#4A4947] " >
  ...
  >
    AI Genie
      ...
      <section className="container mx-auto py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 p-10">
          ...
          <div className="flex flex-col items-center p-8 bg-white text-[#4A4947] rounded-lg shadow-lg transform hover:scale-105 transition duration-300">
            ...
            <h4 className="text-2xl font-bold mb-4">Plan Your Time</h4>
            <p className="text-center">
      ...
      {/* Footer */}
      <footer className="bg-[#4A4947] text-[#D8D2C2] py-8">
