...
export const AdventureDetailsPage = () => {
    ...
    const adventureData = adventuresArray.find((data) => data.id == id);
        ...
        <div className="bg-gradient-to-b from-[#FAF7F0] to-[#D8D2C2] min-h-screen">
            ...
            <div className="container mx-auto px-6 lg:px-12 py-12">
                ...
                <p className="text-md text-[#4A4947] mb-4">
                    {adventureData.rank} | {adventureData.price}, {adventureData.cuisine}
                </p>
                <div className="flex items-center space-x-4 mb-6 text-sm">
                    <span className="text-[#4A4947]">{adventureData.reviews} reviews</span>
                    <span className="text-gold-500 font-semibold">⭐ {adventureData.rank}</span>
                    <span className="text-[#B17457] cursor-pointer hover:underline">💬 Write a Review</span>
                    <span className="text-green-600 font-medium">🕒 {adventureData.timings}</span>
                </div>
            ...
            <div className="container mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-3 gap-12 py-12">
                ...
                <aside className="hidden lg:block lg:sticky lg:top-20 bg-white p-6 rounded-lg shadow-xl h-fit">
                    ...
                    <p className="text-sm text-black">{adventureData.cuisine}</p>
                    <p className="text-sm text-gray-500 mt-4">SPECIAL DIETS</p>
                    <p className="text-sm text-black">{adventureData.specialDiets.join(", ")}</p>
                    ...
                    <div>
                        {activeTab === "details" && (
                            <div className="bg-white p-6 rounded-lg shadow-xl mb-6">
                                ...
                                <ul className="list-disc pl-6 text-[#4A4947]">
                                    {adventureData.highlights.map((highlight, index) => (
                        ...
                        {activeTab === "location" && (
                            <div className="bg-white p-6 rounded-lg shadow-lg mb-6">
                                ...
                                <a href={adventureData.mapLink} className="text-blue-600 mt-2 block hover:underline">{adventureData.mapLink}</a>
                                {/* <p className="text-blue-500 cursor-pointer">{adventureData.mapLink}</p> */}
