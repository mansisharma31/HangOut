...
export const TripDetailsPage = () => {
    ...
    const tripData = tripsArray.find((data) => data.id == id);
        ...
        <div className="bg-gradient-to-b from-[#FAF7F0] to-[#D8D2C2] min-h-screen">
            ...
            <div className="container mx-auto px-6 lg:px-12 py-12">
                ...
                <div className="flex items-center space-x-4 mb-6 text-sm">
                    ...
                    <span className="text-gold-500 font-semibold">⭐ {tripData.rank}</span>
                    <span className="text-[#B17457] cursor-pointer hover:underline">💬 Write a Review</span>
                    <span className="text-green-600 font-medium">🕒 {tripData.timings}</span>
                </div>
                    ...
                    <div>
                        ...
                        {activeTab === "location" && (
                            <div className="bg-white p-6 rounded-lg shadow-lg mb-6">
                                ...
                                <a href={tripData.mapLink} className="text-blue-600 mt-2 block hover:underline">{tripData.mapLink}</a>
                                {/* <p className="text-blue-500 cursor-pointer">{tripData.mapLink}</p> */}
